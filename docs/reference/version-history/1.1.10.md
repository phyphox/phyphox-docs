...
- New sensor rate strategies, which now default to "auto" (see [input module: sensor](../../file-format/input.md#input-module-sensor)).
...
- Support for sensor rate strategies and "stride" (see [input module: sensor](../../file-format/input.md#input-module-sensor))
