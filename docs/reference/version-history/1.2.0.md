...
- Fix: Accept combination of average=true and rate=0 in sensor input (although average is meaningles in that case)
...
- [Camera inputs](../../file-format/input.md#input-module-camera) and [previews](../../file-format/views.md#view-element-camera-gui)
