...
- Fix: Pending network requests are not canceled if the experiment is stopped (network-connections)
...
- Replace "clear" attributes on inputs and outputs with "keep" and "append" in order to make this feature more intuitive (see [Phyphox_file_format#Analysis_modules_in_general](../../file-format/analysis/index.md#analysis-modules-in-general)). The old attributes will still be accepted.
