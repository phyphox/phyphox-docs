...
If this is the first time that you use the editor, you should start with our introduction to our [editor](../editor/index.md) and if you just started to learn about our file format (without using the editor), you should start on the main wiki page about our [file format](index.md). Also, if you are new to Bluetooth Low Energy, you should look for a short introduction, so you know what the terms "GATT", "UUID", "service", "characteristic" and "notification" mean.
